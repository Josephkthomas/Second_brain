            ...
            <>
                      ...
                      <button
                        ...
                        className={clsx(
                          ...
                          isSelected
                            ...
                            : "border-white/10 bg-cyber-slate/30 hover:border-white/20"
                        )}
                      >
                        <div className="flex items-start gap-3">
                          <IconComponent
              ...
              >
                ...
                <div className="space-y-3">
                  {[
                    {
                      value: 'passive' as AnchorEmphasis,
                      label: 'Passive',
                      description: 'Note obvious connections to anchors, but don\'t prioritize them. Good for discovery and avoiding bias.'
                    },
                    {
                      value: 'standard' as AnchorEmphasis,
                      label: 'Standard (Recommended)',
                      description: 'Actively look for connections to anchors while remaining balanced. Best for most use cases.'
                    },
                    {
                      value: 'aggressive' as AnchorEmphasis,
                      label: 'Aggressive',
                      description: 'Strongly prioritize finding and creating connections to anchors. Use when building focused knowledge around specific themes.'
                    }
                  ].map(option => {
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          value={option.value}
                          checked={isSelected}
                          onChange={() => setDefaultAnchorEmphasis(option.value)}
                          className="mt-1"
                        />
                        <div>
                          <div className={clsx(
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-cyber-slate/30 rounded-lg p-4">
                      ...
                      <p className="text-2xl font-bold text-amber-400 mt-1">
                        {stats.averageDuration > 0 ? `${Math.round(stats.averageDuration / 1000)}s` : 'N/A'}
                      </p>
                    </div>
                  </div>
